...
type Circle struct {
	...
	Low      float64 // Height of the material in scene units. Used in 2.5D-3D rendering.
	High     float64 // Height of the material in scene units. Used in 2.5D-3D rendering.
}
...
func (c *Circle) Distance2D(p vector.Vec2) float64 {
...
func (c *Circle) Distance(p vector.Vec3) float64 {
